...
/// Employee Dashboard Screen - menampilkan personal metrics
class EmployeeDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final params = EmployeeStatisticsParams(
      userId: user.id,
      startDate: dateRange.startDate,
      endDate: dateRange.endDate,
    );

    final statisticsAsync = ref.watch(employeeStatisticsProvider(params));
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ref.invalidate(employeeStatisticsProvider(params));
        },
